...
async def get_all_available_country_zone(
    ...
    result = await session.execute(stmt)
    result = result.scalars().all()
    zones = [r.login.split("-")[-1].split("_")[0] for r in result]

    keys = [{'key': 'ge', 'nameOfCountry': 'Грузия'}, {'key': 'uz', 'nameOfCountry': 'Узбекистан'}, {'key': 'lv', 'nameOfCountry': 'Латвия'}, {'key': 'sg', 'nameOfCountry': 'Сингапур'}, {'key': 'pa', 'nameOfCountry': 'Панама'}, {'key': 'us', 'nameOfCountry': 'США'}, {'key': 'ae', 'nameOfCountry': 'ОАЭ'}, {'key': 'jp', 'nameOfCountry': 'Япония'}, {'key': 'md', 'nameOfCountry': 'Молдова'}, {'key': 'es', 'nameOfCountry': 'Испания'}, {'key': 'nl', 'nameOfCountry': 'Нидерланды'}, {'key': 'cz', 'nameOfCountry': 'Чехия'}, {'key': 'fi', 'nameOfCountry': 'Финляндия'}, {'key': 'gb', 'nameOfCountry': 'Великобритания'}, {'key': 'de', 'nameOfCountry': 'Германия'}, {'key': 'it', 'nameOfCountry': 'Италия'}, {'key': 'vn', 'nameOfCountry': 'Вьетнам'}, {'key': 'at', 'nameOfCountry': 'Австрия'}, {'key': 'sk', 'nameOfCountry': 'Словакия'}, {'key': 'am', 'nameOfCountry': 'Армения'}, {'key': 'il', 'nameOfCountry': 'Израиль'}, {'key': 'pl', 'nameOfCountry': 'Польша'}, {'key': 'gr', 'nameOfCountry': 'Греция'}, {'key': 'hu', 'nameOfCountry': 'Венгрия'}, {'key': 'ba', 'nameOfCountry': 'Босния и Герцеговина'}, {'key': 'ee', 'nameOfCountry': 'Эстония'}, {'key': 'ec', 'nameOfCountry': 'Эквадор'}, {'key': 'th', 'nameOfCountry': 'Таиланд'}, {'key': 'bd', 'nameOfCountry': 'Бангладеш'}, {'key': 'ar', 'nameOfCountry': 'Аргентина'}, {'key': 'br', 'nameOfCountry': 'Бразилия'}, {'key': 'si', 'nameOfCountry': 'Словения'}, {'key': 'no', 'nameOfCountry': 'Норвегия'}, {'key': 'lk', 'nameOfCountry': 'Шри-Ланка'}, {'key': 'ma', 'nameOfCountry': 'Марокко'}, {'key': 'pt', 'nameOfCountry': 'Португалия'}, {'key': 'tr', 'nameOfCountry': 'Турция'}, {'key': 'ch', 'nameOfCountry': 'Швейцария'}, {'key': 'bo', 'nameOfCountry': 'Боливия'}, {'key': 'la', 'nameOfCountry': 'Лаос'}, {'key': 'eg', 'nameOfCountry': 'Египет'}, {'key': 'sa', 'nameOfCountry': 'Саудовская Аравия'}, {'key': 'ph', 'nameOfCountry': 'Филиппины'}, {'key': 'pe', 'nameOfCountry': 'Перу'}, {'key': 'al', 'nameOfCountry': 'Албания'}, {'key': 'kw', 'nameOfCountry': 'Кувейт'}, {'key': 'kz', 'nameOfCountry': 'Казахстан'}, {'key': 'bg', 'nameOfCountry': 'Болгария'}, {'key': 'dk', 'nameOfCountry': 'Дания'}, {'key': 'az', 'nameOfCountry': 'Азербайджан'}, {'key': 'nz', 'nameOfCountry': 'Новая Зеландия'}, {'key': 'tm', 'nameOfCountry': 'Туркменистан'}, {'key': 'in', 'nameOfCountry': 'Индия'}, {'key': 'tj', 'nameOfCountry': 'Таджикистан'}, {'key': 'pk', 'nameOfCountry': 'Пакистан'}, {'key': 'kg', 'nameOfCountry': 'Киргизия'}, {'key': 'ie', 'nameOfCountry': 'Ирландия'}, {'key': 'lu', 'nameOfCountry': 'Люксембург'}, {'key': 'ca', 'nameOfCountry': 'Канада'}, {'key': 'se', 'nameOfCountry': 'Швеция'}, {'key': 'hk', 'nameOfCountry': 'Гонконг'}, {'key': 'by', 'nameOfCountry': 'Беларусь'}, {'key': 'lt', 'nameOfCountry': 'Литва'}, {'key': 'fr', 'nameOfCountry': 'Франция'}, {'key': 'iq', 'nameOfCountry': 'Ирак'}, {'key': 'ro', 'nameOfCountry': 'Румыния'}, {'key': 'ua', 'nameOfCountry': 'Украина'}, {'key': 'co', 'nameOfCountry': 'Колумбия'}, {'key': 'za', 'nameOfCountry': 'ЮАР'}, {'key': 'au', 'nameOfCountry': 'Австралия'}, {'key': 'cn', 'nameOfCountry': 'Китай'}, {'key': 'id', 'nameOfCountry': 'Индонезия'}, {'key': 'jm', 'nameOfCountry': 'Ямайка'}, {'key': 'jo', 'nameOfCountry': 'Иордания'}, {'key': 'do', 'nameOfCountry': 'Доминиканская Республика'}, {'key': 'kh', 'nameOfCountry': 'Камбоджа'}, {'key': 'tn', 'nameOfCountry': 'Тунис'}, {'key': 'im', 'nameOfCountry': 'Остров Мэн'}, {'key': 'om', 'nameOfCountry': 'Оман'}, {'key': 'rs', 'nameOfCountry': 'Сербия'}, {'key': 'ng', 'nameOfCountry': 'Нигерия'}, {'key': 'ke', 'nameOfCountry': 'Кения'}, {'key': 'hr', 'nameOfCountry': 'Хорватия'}, {'key': 'ru', 'nameOfCountry': 'Россия'}, {'key': 'cy', 'nameOfCountry': 'Кипр'}, {'key': 'is', 'nameOfCountry': 'Исландия'}, {'key': 'mk', 'nameOfCountry': 'Северная Македония'}, {'key': 'my', 'nameOfCountry': 'Малайзия'}, {'key': 'mx', 'nameOfCountry': 'Мексика'}, {'key': 'be', 'nameOfCountry': 'Бельгия'}, {'key': 'cr', 'nameOfCountry': 'Коста-Рика'}, {'key': 'sl', 'nameOfCountry': 'Сьерра-Леоне'}, {'key': 'kr', 'nameOfCountry': 'Южная Корея'}, {'key': 'tw', 'nameOfCountry': 'Тайвань'}, {'key': 'tz', 'nameOfCountry': 'Танзания'}, {'key': 'zm', 'nameOfCountry': 'Замбия'}, {'key': 'qa', 'nameOfCountry': 'Катар'}, {'key': 'uy', 'nameOfCountry': 'Уругвай'}, {'key': 'mo', 'nameOfCountry': 'Макао'}, {'key': 'cl', 'nameOfCountry': 'Чили'}, {'key': 'gh', 'nameOfCountry': 'Гана'}, {'key': 'cm', 'nameOfCountry': 'Камерун'}, {'key': 'bw', 'nameOfCountry': 'Ботсвана'}, {'key': 'mz', 'nameOfCountry': 'Мозамбик'}, {'key': 'mw', 'nameOfCountry': 'Малави'}, {'key': 'mm', 'nameOfCountry': 'Мьянма'}, {'key': 'bn', 'nameOfCountry': 'Бруней'}, {'key': 've', 'nameOfCountry': 'Венесуэла'}, {'key': 'li', 'nameOfCountry': 'Лихтенштейн'}, {'key': 'cg', 'nameOfCountry': 'Республика Конго'}, {'key': 'zw', 'nameOfCountry': 'Зимбабве'}]
    new_keys = []
    for key in keys:
        if not key.get("key") in zones:
            new_keys.append(key)
    return new_keys
