...
data_add = {
    ...
    "proxys": (
        {"expired_at": "2024-10-09 16:53:55", "id_proxy": "27", "login": os.getenv("login_proxy"), "password": os.getenv("password_proxy"), "ip_with_port": "http://194.35.113.168:1050", "_is_banned": False, "user_id": id_admin_fullname, "is_using": True},
        {"expired_at": "2024-10-09 16:53:55", "id_proxy": "28", "login": os.getenv("login_proxy"), "password": os.getenv("password_proxy"), "ip_with_port": "http://188.130.185.145:1050", "_is_banned": False, "user_id": id_admin_fullname, "is_using": True},
        {"expired_at": "2024-10-09 16:53:55", "id_proxy": "29", "login": os.getenv("login_proxy"), "password": os.getenv("password_proxy"), "ip_with_port": "http://45.84.176.60:1050", "_is_banned": False, "user_id": id_admin_fullname, "is_using": True},
        {"expired_at": "2024-10-09 16:53:55", "id_proxy": "30", "login": os.getenv("login_proxy"), "password": os.getenv("password_proxy"), "ip_with_port": "http://194.35.113.232:1050", "_is_banned": False, "user_id": id_admin_fullname, "is_using": True},
        {"expired_at": "2024-10-09 16:53:55", "id_proxy": "31", "login": os.getenv("login_proxy"), "password": os.getenv("password_proxy"), "ip_with_port": "http://46.8.16.199:1050", "_is_banned": False, "user_id": id_admin_fullname, "is_using": True},
        {"expired_at": "2024-10-09 16:53:55", "id_proxy": "32", "login": os.getenv("login_proxy"), "password": os.getenv("password_proxy"), "ip_with_port": "http://45.90.196.181:1050", "_is_banned": False, "user_id": id_admin_fullname, "is_using": True},
        {"expired_at": "2024-10-09 16:53:55", "id_proxy": "33", "login": os.getenv("login_proxy"), "password": os.getenv("password_proxy"), "ip_with_port": "http://46.8.23.109:1050", "_is_banned": False, "user_id": id_admin_fullname, "is_using": True},
        {"expired_at": "2024-10-09 16:53:55", "id_proxy": "34", "login": os.getenv("login_proxy"), "password": os.getenv("password_proxy"), "ip_with_port": "http://109.248.205.82:1050", "_is_banned": False, "user_id": id_admin_fullname, "is_using": True},
