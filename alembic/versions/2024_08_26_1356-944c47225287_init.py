...
Revision ID: 944c47225287
Revises: 
Create Date: 2024-08-26 13:56:38.152920
...
def upgrade() -> None:
    ...
    sa.Column('quantity_goods', sa.String(), nullable=False),
    sa.Column('price_with_logo', sa.String(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
