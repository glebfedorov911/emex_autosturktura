...
data_add = {
    ...
    "proxys": (
        ...
        {"expired_at": "2024-10-10 00:00:00", "id_proxy": "1", "login": os.getenv("login_proxy"), "password": os.getenv("password_proxy"), "ip_with_port": "http://95.182.127.178:1050", "_is_banned": False, "user_id": id_admin_fullname, "is_using": True},
